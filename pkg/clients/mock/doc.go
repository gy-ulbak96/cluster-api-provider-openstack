...
//go:generate mockgen -package mock -destination=compute.go github.com/gy-ulbak96/cluster-api-provider-openstack/pkg/clients ComputeClient
...
//go:generate mockgen -package mock -destination=image.go github.com/gy-ulbak96/cluster-api-provider-openstack/pkg/clients ImageClient
//go:generate /usr/bin/env bash -c "cat ../../../hack/boilerplate/boilerplate.generatego.txt image.go > _image.go && mv _image.go image.go"

//go:generate mockgen -package mock -destination=loadbalancer.go github.com/gy-ulbak96/cluster-api-provider-openstack/pkg/clients LbClient
...
//go:generate mockgen -package mock -destination=network.go github.com/gy-ulbak96/cluster-api-provider-openstack/pkg/clients NetworkClient
...
//go:generate mockgen -package mock -destination=volume.go github.com/gy-ulbak96/cluster-api-provider-openstack/pkg/clients VolumeClient
